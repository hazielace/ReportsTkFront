...
<script>
import { listReports, addReport, downloadReport, logout } from "@/helpers/fullStore";
...
export default {
    ...
    methods: {
        ...
        addReport() {
            ...
            addReport(this.title, this.startdate, this.enddate).then((res) => {
                console.log("Reporte agregado:", res);
                this.title = '';
                this.startdate = '';
                this.enddate = '';
                this.getReports();
        ...
        listenForNewReports() {
            window.Echo.channel("reports").listen("ReportGeneratedEvent", (data) => {
                ...
                console.log("Error al conectar con el evento: ", error);
            });
        }
    },
    mounted() {
